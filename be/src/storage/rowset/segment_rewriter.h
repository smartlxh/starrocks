...
public:
    ...
    static StatusOr<int64_t> rewrite(const std::string& src, const std::string& dest,
    ...
    static Status<int64_t> rewrite(const std::string& src_path, const std::string& dest_path, const TabletSchemaCSPtr& tschema,
