...
Status JniScanner::_init_jni_method(JNIEnv* _jni_env) {
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get `open` jni method"));

    _jni_scanner_get_next_chunk = _jni_env->GetMethodID(_jni_scanner_cls, "getNextOffHeapChunk", "()J");
    RETURN_IF_ERROR(
            JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get `getNextOffHeapChunk` jni method"));

    _jni_scanner_close = _jni_env->GetMethodID(_jni_scanner_cls, "close", "()V");
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get `close` jni method"));

    _jni_scanner_release_column = _jni_env->GetMethodID(_jni_scanner_cls, "releaseOffHeapColumnVector", "(I)V");
    RETURN_IF_ERROR(
            JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get `releaseOffHeapColumnVector` jni method"));

    _jni_scanner_release_table = _jni_env->GetMethodID(_jni_scanner_cls, "releaseOffHeapTable", "()V");
    RETURN_IF_ERROR(
            JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get `releaseOffHeapTable` jni method"));
    return Status::OK();
}
...
Status JniScanner::_init_jni_table_scanner(JNIEnv* _jni_env, RuntimeState* runtime_state) {
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to init the scanner class."));
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get a scanner class constructor."));
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to get the HashMap methods."));
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(_jni_env, "Failed to initialize a scanner instance."));
...
Status JniScanner::_get_next_chunk(JNIEnv* _jni_env, long* chunk_meta) {
    ...
    *chunk_meta = _jni_env->CallLongMethod(_jni_scanner_obj, _jni_scanner_get_next_chunk);
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(
            _jni_env, "Failed to call the nextChunkOffHeap method of off-heap table scanner."));
    return Status::OK();
}
...
Status JniScanner::_release_off_heap_table(JNIEnv* _jni_env) {
    ...
    RETURN_IF_ERROR(JVMFunctionHelper::_check_jni_exception(
            _jni_env, "Failed to call the releaseOffHeapTable method of off-heap table scanner."));
    return Status::OK();
}
