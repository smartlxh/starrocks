...
import com.aliyun.datalake.auth.resource.ColumnResource;
...
public class DlfAccessController extends ExternalAccessController implements AccessController {
    ...
    public void checkColumnAction(UserIdentity currentUser, Set<Long> roleIds, TableName tableName,
        ...
        hasPermission(new PrivilegeResource()
                        .setAccess(convertToAccessType(privilegeType))
                        .setMetaResource(new MetaResource().setResourceType("COLUMN")
                                .setColumnResource(new ColumnResource()
                                        .setDatabaseName(tableName.getDb())
                                        .setTableName(tableName.getTbl())
                                        .setColumnNames(List.of(column)))),
                currentUser);
    }
